...
class ParseProperties:
    def parse_file(self, save, directory, properties) -> None:
        file = pd.read_csv(directory, sep=";", usecols=["I", "J", "Model", properties]).fillna("nan")
        ...
        final.to_csv(save, index=False, header=False, doublequote=False, quoting=csv.QUOTE_NONE, quotechar="", escapechar=" ")
